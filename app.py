...
# ── Brand list ─────────────────────────────────────────────────────────────
BRANDS = [
    'ADATA', 'Corsair', 'Crucial', 'G.Skill', 'GeIL',
    'HyperX', 'Kingston', 'Klevv', 'Lexar', 'Micron',
    'Mushkin', 'OLOy', 'Patriot', 'PNY', 'Samsung',
    'Silicon Power', 'SK Hynix', 'TeamGroup', 'Thermaltake',
    'Transcend', 'V-Color', 'XPG', 'Generic / Off-Brand', 'Other',
]
